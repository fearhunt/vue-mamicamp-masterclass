<template>
  <form @submit.prevent="save">
    <div class="form-group">
      ...
      <input v-model="form.title" @blur="$v.form.title.$touch()" type="text" id="thread_title" class="form-input" name="title">
    ...
    <div class="form-group">
      ...
      <textarea v-model="form.text" @blur="$v.form.text.$touch()" id="thread_content" class="form-input" name="content" rows="8" cols="140"></textarea>
