  ...
  <div class="col-3 push-top">
    <div class="profile-card">
      ...
      <div class="form-group">
        <input v-model.lazy="activeUser.username" @blur="$v.activeUser.username.$touch()" type="text" placeholder="Username" class="form-input text-lead text-bold">
      ...
      <div class="form-group">
        <input v-model="activeUser.name" @blur="$v.activeUser.name.$touch()" type="text" placeholder="Full Name" class="form-input text-lead">
      ...
      <div class="form-group">
        ...
        <input v-model.lazy="activeUser.email" @blur="$v.activeUser.email.$touch()" autocomplete="off" class="form-input" id="user_email">
